...
type AdminRolePriv struct {
	Id     int    `form:"id" json:"id" xorm:"not null pk autoincr INT(10)"`
	RoleId int    `form:"role_id" json:"role_id" xorm:"not null default 0 index index(role_id_2) SMALLINT(3)"`
	S      string `form:"s" json:"s" xorm:"not null default '' index(role_id_2) CHAR(100)"`
	Data   string `form:"data" json:"data" xorm:"not null default '' CHAR(50)"`
	Aid    int    `form:"aid" json:"aid" xorm:"not null default 0 INT(10)"`
	MenuId int    `form:"menu_id" json:"menu_id" xorm:"not null default 0 INT(10)"`
