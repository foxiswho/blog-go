...
type Session struct {
	...
	Uid        int       `form:"uid" json:"uid" xorm:"not null default 0 index(uid) INT(11)"`
	...
	ErrorCount int       `form:"error_count" json:"error_count" xorm:"not null default 0 TINYINT(1)"`
	AppId      int       `form:"app_id" json:"app_id" xorm:"not null default 0 INT(11)"`
	TypeLogin  int       `form:"type_login" json:"type_login" xorm:"not null default 0 index(uid) INT(11)"`
	Md5        string    `form:"md5" json:"md5" xorm:"not null default '' CHAR(32)"`
	TypeClient int       `form:"type_client" json:"type_client" xorm:"not null default 0 index(uid) INT(11)"`
}
