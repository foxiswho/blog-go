...
import (
	...
	"github.com/hongmengzhu/xianfu-blog-go/app/manage/domainRam/model/modRamResource"
...
func (c *ResourceController) RegisterRoutes(e *gin.Engine) {
	group := e.Group("/pg2lq/manage/ram/resource", authPg.GroupManageMiddleware(c.Sp))
