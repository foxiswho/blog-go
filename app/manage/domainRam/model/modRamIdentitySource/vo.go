...
type Vo struct {
	...
	Configured         typePg.Int8         `json:"configured" label:"是否配置" `               // 是否配置
	EnableSlo          typePg.Int8         `json:"enableSlo" label:"单点登出" `                // 单点登出
	AutoCreateUser     typePg.Int8         `json:"autoCreateUser" label:"自动创建用户" `       // 自动创建用户
