...
func init() {
	gs.Provide(new(BasicConfigModelRepository)).Init(func(s *BasicConfigModelRepository) {
		syslog.Debugf(context.Background(), syslog.TagAppDef, "%+v initialized successfully", reflect.TypeOf(s).String())
	})

	gs.Provide(new(support.BaseService[BasicConfigModelRepository])).Init(func(s *support.BaseService[BasicConfigModelRepository]) {
		syslog.Debugf(context.Background(), syslog.TagAppDef, "%+v initialized successfully", reflect.TypeOf(s).String())
	})
}
