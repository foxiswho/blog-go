...
func init() {
	gs.Provide(new(RamAccountAuthMfaRepository)).Init(func(s *RamAccountAuthMfaRepository) {
		log.Debugf(context.Background(), log.TagAppDef, "%+v initialized successfully", reflect.TypeOf(s).String())
	})

	gs.Provide(new(support.BaseService[RamAccountAuthMfaRepository])).Init(func(s *support.BaseService[RamAccountAuthMfaRepository]) {
		log.Debugf(context.Background(), log.TagAppDef, "%+v initialized successfully", reflect.TypeOf(s).String())
	})
}
